...
const translations: Translations = {
  ...
  'hero.subtitle': { pt: 'Soluções completas para empreendedores que querem vender mais com presença digital profissional', en: 'Complete solutions for entrepreneurs who want to sell more with professional digital presence' },
  ...
  'how-it-works.step1.description': { pt: 'Entendemos o seu negócio e criamos uma presença digital feita para atrair clientes.', en: 'We understand your business and create a digital presence designed to attract customers.' },
  ...
  'who-is-it-for.subtitle': { pt: 'Nossas soluções são perfeitas para empreendedores que querem dominar o mercado digital', en: 'Our solutions are perfect for entrepreneurs who want to dominate the digital market' },
  'who-is-it-for.audience1.title': { pt: 'Empreendedores Digitais', en: 'Digital Entrepreneurs' },
  'who-is-it-for.audience1.subtitle': { pt: 'Que querem escalar vendas', en: 'Who want to scale sales' },
  'who-is-it-for.audience1.description': { pt: 'Profissionais que buscam automatizar processos e aumentar receita através da tecnologia.', en: 'Professionals seeking to automate processes and increase revenue through technology.' },
  'who-is-it-for.audience2.title': { pt: 'Empresas Locais', en: 'Local Businesses' },
  'who-is-it-for.audience2.subtitle': { pt: 'Que querem crescer online', en: 'Who want to grow online' },
  'who-is-it-for.audience2.description': { pt: 'Negócios tradicionais que precisam de presença digital forte para competir no mercado.', en: 'Traditional businesses that need a strong digital presence to compete in the market.' },
  'who-is-it-for.audience3.title': { pt: 'Profissionais de Serviços', en: 'Service Professionals' },
  'who-is-it-for.audience3.subtitle': { pt: 'Que querem mais clientes', en: 'Who want more clients' },
  'who-is-it-for.audience3.description': { pt: 'Consultores, freelancers e prestadores que querem atrair mais clientes qualificados.', en: 'Consultants, freelancers and service providers who want to attract more qualified clients.' },
  'who-is-it-for.audience4.title': { pt: 'E-commerce', en: 'E-commerce' },
  'who-is-it-for.audience4.subtitle': { pt: 'Que querem vender mais', en: 'Who want to sell more' },
  'who-is-it-for.audience4.description': { pt: 'Lojas online que buscam aumentar conversões e otimizar a experiência do cliente.', en: 'Online stores seeking to increase conversions and optimize customer experience.' },
  'who-is-it-for.examples1': { pt: 'Consultores, Coaches, Mentores, Freelancers', en: 'Consultants, Coaches, Mentors, Freelancers' },
  'who-is-it-for.examples2': { pt: 'Restaurantes, Cafés, Lojas, Serviços', en: 'Restaurants, Cafés, Stores, Services' },
  'who-is-it-for.examples3': { pt: 'Advogados, Médicos, Contadores, Arquitetos', en: 'Lawyers, Doctors, Accountants, Architects' },
  'who-is-it-for.examples4': { pt: 'Moda, Beleza, Casa, Tecnologia', en: 'Fashion, Beauty, Home, Technology' },
  ...
  'who-is-it-for.bottom.description': { pt: 'Vamos criar uma estratégia personalizada para transformar seu negócio em uma máquina de vendas digital.', en: 'Let\'s create a personalized strategy to transform your business into a digital sales machine.' },
  'who-is-it-for.cta': { pt: 'Quero uma estratégia personalizada', en: 'I want a personalized strategy' },
